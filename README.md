...
```
cd existing_repo
git remote add origin https://gitlab-stud.elka.pw.edu.pl/hnguyen2/epfu24w-103-d-penguins.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab-stud.elka.pw.edu.pl/hnguyen2/epfu24w-103-d-penguins/-/settings/integrations)
